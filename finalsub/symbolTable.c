...
symbolTable* insertSTSwitch(astNode* node, symbolTable* table){
    ...
    */
    ...
    case 125:
        ...
        record ->scopePointer->scopeBeginLine = node ->leftChild ->rightSibling->pt->element.t.line_no;
        temp = node ->leftChild ->rightSibling;
        while(temp -> rightSibling != NULL){
            temp  = temp -> rightSibling;
        }
        record->scopePointer->scopeEndLine = temp ->pt->element.t.line_no;
        counter++;
        return record -> scopePointer;
        break; 
    ...
    case 134:
        ...
        record ->scopePointer->scopeBeginLine = node ->leftChild ->rightSibling->rightSibling ->pt->element.t.line_no;
