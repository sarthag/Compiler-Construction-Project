...
typedef enum ICGlabels{
    INT_ADD, INT_SUB, INT_MUL, INT_DIV, REAL_ADD, REAL_SUB, REAL_MUL, REAL_DIV, INT_TO_REAL, BOOL_AND, BOOL_OR, ROP_INT_LT, ROP_INT_LE, ROP_INT_EQ, ROP_INT_NE, ROP_INT_GT, ROP_INT_GE, ROP_REAL_LT, ROP_REAL_LE, ROP_REAL_EQ, ROP_REAL_NE, ROP_REAL_GT, ROP_REAL_GE
}icgLabels;
